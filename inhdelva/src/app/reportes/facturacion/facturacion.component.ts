          ...
          (data: any[]) => {
            ...
            this.listOfData.forEach(y => {
              this.dataExport = [...this.dataExport, {
                ...
                'Fraccion de energia solar en autoocnsumo (FS)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(y.FS ),
                'Precio base de energia (PBE)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.PBE ),
                ...
                'Precio base potencia (PBP)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.PBP ),
                ...
                'Costo operativo sistema solar (COS)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.COS ),
                'Costo operativo mantenimiento red de distribucion (COR)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.COR ),
                'Costo operativo de mantenimiento de equipos auxiliares (COE)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.COE ),
                'Costos administrativos (COA)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.COA ),
                'Punto de medida': y.PuntoMedida,
                'Perdidas internas (PI)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(y.PI ),
                ...
                'Precio de la energia tarifa Alumbrado Público (EAP)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.EAP ),
                ...
                'Precio de la energia tarifa Servicio General de Baja Tensión (EBT)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.EBT ),
                'Energía total consumida por los usuarios (ETCU) ': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(y.ETCU ),
                ...
                'CARGOS TOTALES TARIFA': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(y.TOTAL )
              }]
            });
            ...
            this.dataExport = [...this.dataExport, {
              ...
              'Fraccion de energia solar en autoocnsumo (FS)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[4] ),
              'Precio base de energia (PBE)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[5] ),
              ...
              'Precio base potencia (PBP)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[8] ),
              ...
              'Costo operativo sistema solar (COS)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[12] ),
              'Costo operativo mantenimiento red de distribucion (COR)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[13] ),
              'Costo operativo de mantenimiento de equipos auxiliares (COE)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[14] ),
              'Costos administrativos (COA)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4}).format(this.listaTotales[15] ),
              'Punto de medida': this.listaTotales[17],
              'Perdidas internas (PI)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[18] ),
              'Cargo por perdidas internas (CPI)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[19] ),
              'Energia activa consumida en Alumbrado Público (EAAP)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[20] ),
              'Precio de la energia tarifa Alumbrado Público (EAP)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[21] ),
              'Energía total consumida por los usuarios (ETCU)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[22] ),
              'Cargo por iluminación comunitaria (CIC)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[23] ),
              'Energia activa consumida en servicios comunitarios (EASC)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[24] ),
              'Precio de la energia tarifa Servicio General de Baja Tensión (EBT)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[25] ),
              'Energía total consumida por los usuarios (ETCU) ': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[26] ),
              'Cargo por servicios comunitarios (CSC)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[27] ),
              'CARGOS TOTALES TARIFA': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.listaTotales[28] )
            }]
