          ...
          (data: any[]) => {
            ...
            this.listOfData.forEach(y => {
              this.dataExport = [...this.dataExport, {
                ...
                'Cargo por energia(CPE)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.CPE),
                ...
                'Perdidas internas (PI)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(y.PI),
            ...
            this.dataExport = [...this.dataExport, {
              ...
              'Cargo por energia(CPE)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[6]),
              ...
              'Perdidas internas (PI)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[23]),
              ...
              'Precio de la energia tarifa Alumbrado Público (EAP)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[29]),
              ...
              'Precio de la energia tarifa Servicio General de Baja Tensión (EBT)': new Intl.NumberFormat('en-us', { minimumFractionDigits: 2, maximumFractionDigits: 4 }).format(this.listaTotales[35]),
